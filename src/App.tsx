                    ...
                    {showResults && analysisResults.length > 0 && (
                        <Card className="results-card">
                            ...
                            <div className="results-description">
                                <p>
                                    Advanced K-Nearest Neighbors Analysis Engine, predicting bucket landing positions based on
                                    drop position, ball bounciness, and ball size parameters.
                                </p>
                            </div>
